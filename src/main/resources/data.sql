...
INSERT INTO quote (quote_id, quote_name, author, created_at,updated_at) VALUES (nextval('quote_seq'), 'You’ve gotta dance like there’s nobody watching, love like you’ll never be hurt, sing like there’s nobody listening, and live like it’s heaven on earth.','William W. Purkey',current_timestamp,current_timestamp); 
INSERT INTO quote (quote_id, quote_name, author, created_at,updated_at) VALUES (nextval('quote_seq'), 'Fairy tales are more than true: not because they tell us that dragons exist, but because they tell us that dragons can be beaten.','Neil Gaiman',current_timestamp,current_timestamp); 
INSERT INTO quote (quote_id, quote_name, author, created_at,updated_at) VALUES (nextval('quote_seq'), 'Everything you can imagine is real','Pablo Picasso',current_timestamp,current_timestamp); 
INSERT INTO quote (quote_id, quote_name, author, created_at,updated_at) VALUES (nextval('quote_seq'), 'When one door of happiness closes, another opens; but often we look so long at the closed door that we do not see the one which has been opened for us.','Helen Keller',current_timestamp,current_timestamp); 
INSERT INTO quote (quote_id, quote_name, author, created_at,updated_at) VALUES (nextval('quote_seq'), 'Do one thing every day that scares you.','Eleanor Roosevelt',current_timestamp,current_timestamp); 
INSERT INTO quote (quote_id, quote_name, author, created_at,updated_at) VALUES (nextval('quote_seq'), 'Smart people learn from everything and everyone, average people from their experiences, stupid people already have all the answers.','Socrates',current_timestamp,current_timestamp); 
